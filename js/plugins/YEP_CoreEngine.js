...
Window_Base.prototype.drawCurrentAndMax = function(current, max, x, y,
    ...
    var valueWidth = this.textWidth(Yanfly.Param.ActorMaxHp);
    ...
    if (x3 >= x + labelWidth) {
        ...
        var padMax = Yanfly.Util.toGroup(max).padStart(4, ' ');
        this.drawText(padMax, x1, y, valueWidth, 'right');
    } else {
        this.changeTextColor(color1);
...
Window_Base.prototype.drawActorHp = function(actor, x, y, width) {
    ...
    this.drawCurrentAndMax(actor.hp, actor.mhp, x, y, width,
                   this.hpColor(actor), this.maxColor());
...
Window_Base.prototype.drawActorMp = function(actor, x, y, width) {
	...
	this.drawCurrentAndMax(actor.mp, actor.mmp, x, y, width,
                       this.mpColor(actor), this.maxColor());

};

Window_Base.prototype.maxColor = function() {
...
Window_ItemList.prototype.drawItem = function(index) {
  ...
  if (item) {
      var numberWidth = this.textWidth('00');
      var rect = this.itemRect(index);
