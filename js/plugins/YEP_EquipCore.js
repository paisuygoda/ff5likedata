...
Game_Actor.prototype.changeEquip = function(slotId, item) {
    ...
    if(this._equips[1]._itemId == 0) this._equips[1].setEquip(this.isDualWield(), 1);
...
Game_Actor.prototype.paramPlus = function(paramId) {
    ...
    value += this.customParamPlus(paramId);
    return value;
};

/* MyMiscPluginに書いた内容が上書きされないよう削除
Game_Actor.prototype.customParamPlus = function(paramId) {
    return 0;
};
*/
